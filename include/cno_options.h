...
CNO_Option_type CNO_Options = {
	...
	{'g',"gui",(GOPT_ARGUMENT_FORBIDDEN),0,NULL},//Opens a window; good for letting the air out.
	{'G',"global-colours",(GOPT_ARGUMENT_FORBIDDEN),0,NULL},//Use global terminal colour system.
	{'i',"stdin",(GOPT_ARGUMENT_FORBIDDEN),0,NULL},//Offloads all the hard decision making onto the user.
	{'I',"input",(GOPT_ARGUMENT_REQUIRED|GOPT_ARGUMENT_NO_HYPHEN),0,NULL},//File: Uses the given file instead of STDIN.
	...
	{'l',"log",(GOPT_ARGUMENT_REQUIRED|GOPT_ARGUMENT_NO_HYPHEN),0,NULL},//
	...
	{'r',"repl",(GOPT_ARGUMENT_FORBIDDEN),0,NULL},//Search directories recursively.
	...
	{'t',"test",(GOPT_ARGUMENT_FORBIDDEN),0,NULL},//Run automated test.
	{'T',"text",(GOPT_ARGUMENT_REQUIRED|GOPT_ARGUMENT_NO_HYPHEN)
	{'u',"user",(GOPT_ARGUMENT_REQUIRED|GOPT_ARGUMENT_NO_HYPHEN),0,NULL},//Username: Exempli gratia: local user -> \'luser\'.
